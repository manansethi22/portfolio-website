...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40 flex items-center justify-center">
      <div className="w-11/12 md:max-w-[600px] md:w-full relative bg-white rounded-[8px] p-5">
        <div>
          <figure>
